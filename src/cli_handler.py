...
class CLIHandler:
    ...
    def create_argument_parser(self) -> argparse.ArgumentParser:
        ...
        parser = argparse.ArgumentParser(
            description='PDFCraft - Split PDFs by bookmarks and convert to markdown',
  ...
  python -m src.main https://example.com/document.pdf --level 0 \\
    ...
    def run(self, args: Optional[List[str]] = None) -> int:
        ...
        try:
            ...
            if not bookmarks:
                self.logger.error("No bookmarks match the specified criteria")
                return 1
            ...
            if parsed_args.convert_markdown:
                ...
                self.logger.info(f"Converted {len(markdown_files)} files to markdown")
